...
<?php
//var_dump($flight);
echo $response = $soap = new SimpleXMLElement($flight);
if( 1 == 1){
...
<?php echo form_open(base_url() . "booking/register"); ?>
                        ...
                        <div class="event-content">
                            ...
                            <div class="event-content-data">
                                ...
                                <div style="float: right; margin: 5px 0 2px" data-role="input-control" class="input-control radio margin10">
                                    <label>
                                        <input type="radio" value="<?php echo $values['FlightNumber']; ?>" name="flight_selected">
