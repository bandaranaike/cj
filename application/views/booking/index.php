...
<script src="<?php echo base_url(); ?>content/js/jquery-ui_1.js" type="text/javascript"></script>
<link href="<?php echo base_url(); ?>content/css/jquery-ui.css" rel="stylesheet" type="text/css"/>
<script>
    $(function () {
        var cache = {};
        $("#from_location").autocomplete({
            ...
            source: function (request, response) {
                ...
                $.getJSON("<?php echo base_url(); ?>content/js/airports.json", request, function (data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            }
                        ...
                        <div class="frame" id="_page_1">
                            ...
                            <label style="width: 48%; margin-right: 3%; float: left">From
                                <div class="input-control text">
                                    <?php echo form_input(array("name"=>"from_location","id"=>"from_location"), "CDG"); ?>
                                </div>
                            </label>
                            ...
                            <div data-role="input-control" class="input-control switch" style="width: 100%">
                                <div class="clearfix">
                                    <label style="width: 48%; margin-right: 3%; float: left">Departure Date
                                        <div data-week-start="1" data-role="datepicker" class="input-control text">
                                            <?php echo form_input("start_date"); ?>
                                            <button class="btn-date"></button>
                                        </div>
                                    </label>
                                    <label style="width: 48%; float: left">Arrival Date
                                        <div data-week-start="1" data-role="datepicker" class="input-control text">
